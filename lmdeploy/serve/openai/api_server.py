...
VariableInterface.depends.append(Depends(validate_json_request))
...
@router.post('/generate', dependencies=VariableInterface.depends)
...
@router.post('/v1/chat/interactive', dependencies=VariableInterface.depends, include_in_schema=False)
